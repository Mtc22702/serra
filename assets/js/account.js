...
(function () {
  ...
  function tAcc(key, vars = {}) {
    const i18n = window.ACCOUNT_I18N || { it: {}, ro: {} };
    const dict = i18n[currentLang] || i18n.it;
    let val = dict[key] || i18n.it[key] || key;
  ...
  function renderAdminDashboard() {
    ...
    // Ripristina l'ultimo tab attivo se salvato
    const activeTab = localStorage.getItem("serra.active_admin_tab") || "plants";
  ...
  window.switchAdminTab = function (tab) {
    localStorage.setItem("serra.active_admin_tab", tab);
