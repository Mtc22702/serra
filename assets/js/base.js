...
(function (global) {
  const shared = {
    ...
    index: {
      it: {
        ...
        "hero.headline_a": "Dai forma al tuo orto.",
        "hero.headline_b": "Seguilo fino al raccolto.",
        ...
        "journey.choice_kicker": "Tre modi per iniziare",
        "journey.choice_title": "Scegli il percorso giusto per il tuo orto",
        "journey.choice_sub":
          "Parti dalla situazione in cui ti trovi: puoi cambiare strada in qualsiasi momento.",
        "journey.choice_hint":
        ...
        "journey.step1_title": "Crea il tuo piano",
        "journey.step1_copy":
        ...
        "journey.step2_title": "Scegli semi o piantine",
        "journey.step2_badge": "due modi",
        "journey.step2_help": "Confronta semi e piantine",
        "journey.step2_choices_aria": "Scegli tra semi e piantine",
        "journey.step2_copy":
          "Dal seme costa meno, dalla piantina guadagni fino a un mese sulla raccolta.",
        "journey.semi_label": "Parto dai semi",
        ...
        "journey.preview_water": "Annaffia i pomodori",
        ...
        "bridge.vivaio_title": "Vuoi raccogliere prima?",
        "bridge.vivaio_copy":
          "Scegli piantine già avviate, salta la germinazione e guadagna tempo sulla prima raccolta.",
        "bridge.vivaio_available": "Disponibili questo mese",
        "bridge.vivaio_plant_note": "Piantina già avviata",
      ...
      ro: {
        ...
        "hero.headline_a": "Dă formă grădinii tale.",
        "hero.headline_b": "Îngrijește-o până la recoltă.",
        "hero.eyebrow_now": "· alege de unde pornești",
        "hero.plan_caption": "Exemplu de plan · 4 straturi, 12 m²",
        "journey.choice_kicker": "Trei moduri de a începe",
        "journey.choice_title": "Alege parcursul potrivit pentru grădina ta",
        "journey.choice_sub":
          "Pornește de la situația în care te afli: poți schimba direcția oricând.",
        "journey.choice_hint":
        ...
        "journey.step1_title": "Creează-ți planul",
        "journey.step1_copy":
        ...
        "journey.step2_title": "Alege semințe sau răsaduri",
        "journey.step2_badge": "două moduri",
        "journey.step2_help": "Compară semințele și răsadurile",
        "journey.step2_choices_aria": "Alege între semințe și răsaduri",
        "journey.step2_copy":
          "De la sămânță costă mai puțin, de la răsad câștigi până la o lună la recoltare.",
        "journey.semi_label": "Pornesc de la semințe",
        ...
        "journey.preview_water": "Udă roșiile",
        ...
        "bridge.vivaio_copy":
          "Alege răsaduri deja pornite, sari peste germinare și câștigă timp până la prima recoltă.",
        "bridge.vivaio_available": "Disponibile luna aceasta",
        "bridge.vivaio_plant_note": "Răsad deja pornit",
    ...
    configurator: {
      it: {
        ...
        "projects.intro":
          "Salva versioni della tua serra e riprendi da dove eri rimasto.",
        "projects.new": "Nuovo progetto",
        "projects.current": "Progetto attuale",
        "projects.others": "Altri progetti",
        "projects.open": "Apri",
        "projects.updated": "Aggiornato il {date}",
      ...
      ro: {
        ...
        "projects.intro":
          "Salvează versiuni ale serei tale și continuă de unde ai rămas.",
        "projects.new": "Proiect nou",
        "projects.current": "Proiect activ",
        "projects.others": "Alte proiecte",
        "projects.open": "Deschide",
        "projects.updated": "Actualizat la {date}",
  ...
  shared.account = {
    it: {
      ...
      "dash.account_eyebrow": "Il tuo spazio",
      "dash.summary_aria": "Riepilogo account",
      "dash.summary_projects": "Serre salvate",
      "dash.summary_orders": "Ordini",
      "dash.summary_varieties": "Varietà acquistate",
      "dash.sections_aria": "Sezioni dell'account",
      "dash.nav_profile": "Fatturazione e spedizione",
      "dash.nav_projects": "Le mie serre",
      ...
      "profile.company_name": "Ragione sociale",
      "profile.vat_number": "Partita IVA",
      "profile.tax_code": "Codice fiscale",
      ...
      "dash.manual_btn_hint": "Per le piante di questo ordine · PDF",
      "order.edit_button": "Modifica ordine",
      ...
      "order.unit_price": "prezzo unitario",
      "order.quantity_for": "Quantità per {name}",
      ...
      "packing.pick": "Preleva",
      "packing.verify": "Verifica",
      "packing.pack": "Imballa",
      "packing.products": "prodotti",
      "packing.units": "confezioni",
      "packing.picked": "Prelevato",
      "packing.packed": "Imballato",
      "packing.operator": "Operatore",
      ...
      "invoice.vat_number": "Partita IVA",
      "invoice.tax_code": "Codice fiscale",
      "invoice.company_customer": "Cliente aziendale",
    ...
    ro: {
      ...
      // Testi del cruscotto riservato all'utente autenticato.
      "dash.account_eyebrow": "Spațiul tău",
      "dash.summary_aria": "Rezumatul contului",
      "dash.summary_projects": "Sere salvate",
      "dash.summary_orders": "Comenzi",
      "dash.summary_varieties": "Soiuri cumpărate",
      "dash.sections_aria": "Secțiunile contului",
      "dash.nav_profile": "Facturare și livrare",
      "dash.nav_projects": "Serele mele",
      ...
      "profile.company_name": "Denumirea companiei",
      "profile.vat_number": "Cod TVA",
      "profile.tax_code": "Cod fiscal",
      ...
      "dash.products_summary_one_one": "{count} produs · {units} pachet",
      "dash.products_summary_one_many": "{count} produs · {units} pachete",
      "dash.products_summary_many_one": "{count} produse · {units} pachet",
      "dash.products_summary_many_many": "{count} produse · {units} pachete",
      "dash.print_btn": "Tipărește chitanța",
      "dash.print_btn_hint": "Rezumatul achiziției",
      "dash.manual_btn": "Manual de cultivare",
      "dash.manual_btn_hint": "Pentru plantele din această comandă · PDF",
      "order.edit_button": "Modifică comanda",
      ...
      "order.unit_price": "preț unitar",
      "order.quantity_for": "Cantitate pentru {name}",
      ...
      "packing.pick": "Colectează",
      "packing.verify": "Verifică",
      "packing.pack": "Ambalează",
      "packing.products": "produse",
      "packing.units": "pachete",
      "packing.picked": "Colectat",
      "packing.packed": "Ambalat",
      "packing.operator": "Operator",
      ...
      "invoice.vat_number": "Cod TVA",
      "invoice.tax_code": "Cod fiscal",
      "invoice.company_customer": "Client companie",
